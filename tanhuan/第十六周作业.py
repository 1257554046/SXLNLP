...
class DialogSystem:
    ...
    def load(self):
        ...
        self.load_scenario("/Users/tanhuan/Downloads/八斗/week16 对话系统/scenario/scenario-买衣服.json")
        # self.load_scenario("scenario-看电影.json")

        # 加载槽位模板
        self.slot_info = {}
        self.slot_template("/Users/tanhuan/Downloads/八斗/week16 对话系统/scenario/slot_fitting_templet.xlsx")
    ...
    def get_slot(self, memory):
        # 槽位抽取
        if re.search("没听清|重复", memory["user_input"]):
            memory["repeat"] = True
            return memory
    ...
    def generate_response(self, user_input, memory):
        ...
        return memory.get("bot_response", "你要干啥"), memory
